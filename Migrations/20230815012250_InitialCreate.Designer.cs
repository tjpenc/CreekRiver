...
namespace CreekRiver.Migrations
{
    ...
    [Migration("20230815012250_InitialCreate")]
            ...
            modelBuilder.Entity("CreekRiver.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CampsiteId = 1,
                            CheckinDate = new DateTime(2023, 8, 14, 21, 22, 50, 426, DateTimeKind.Local).AddTicks(7888),
                            CheckoutDate = new DateTime(2023, 8, 14, 21, 22, 50, 426, DateTimeKind.Local).AddTicks(7963),
                            UserProfileId = 1
                        });
                });
